...
class ProcessEvents(pyinotify.ProcessEvent):
    ...
    def run_tests(self):
        ...
        process = subprocess.Popen(
            'make test-unit-xml --no-print-directory',
...
notifier = pyinotify.Notifier(watch_manager, event_processor)
...
# Just run tests first time for some feedback.
event_processor.run_tests()
